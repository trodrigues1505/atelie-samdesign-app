...
export default function CheckoutPage() {
  ...
  const frete = calculateFrete(totalWeightGramas);
      ...
      <div>
        ...
        <div className="mt-4 flex flex-col gap-2 rounded-lg border border-border p-4 text-sm">
          ...
          <div className="flex justify-between">
            <span className="text-muted-foreground">Frete (provisório)</span>
        ...
        <p className="mt-2 text-xs text-muted-foreground">
          O valor do frete é uma estimativa provisória baseada no peso — será
          substituído pelo cálculo real dos Correios em breve.
        </p>
      </div>
    </div>
  );
