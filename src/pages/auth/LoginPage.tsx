    ...
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 bg-muted px-4">
      ...
      <div className="flex w-full max-w-sm flex-col gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 rounded-lg border border-border bg-black px-4 py-3 font-medium text-white shadow-sm transition hover:bg-black/80"
        >
          <GithubIcon />
          Entrar com GitHub
        </button>
